...
| Change numerical models, pipeline stages, persistence, figures, or CLI behavior | [Source architecture](src/README.md) |
...
Data comes from [`yfinance`](https://github.com/ranaroussi/yfinance); the BTC workspace additionally uses the [CoinMetrics Community API](https://docs.coinmetrics.io/api/v4). The method references Davison & Hinkley (1997), Benjamini & Hochberg (1995), White (2000), Lopez de Prado (2018), Politis & Romano (1994), and Karatzas & Shreve (1991). Indicator definitions follow Wilder RSI/ATR, Appel MACD, and Bollinger Bands.
